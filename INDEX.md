...
- **2026-08-17** · 新增 Go 笔记：go-zero-looklook-new（2026 升级版）项目归档
  ...
  - **目录调整**：归档原计划放在 `golang/notes/go-zero/looklook-new/`，后调整为同级 `golang/notes/go-zero-looklook-new/`，因为它是「一个完整项目」而非「go-zero 框架的一个子集」
...
- **2026-07-22** · 新增 Go 笔记：go-clean-arch · 三层 Article 字段重合但不是冗余（1 篇）
  ...
  - 关键价值：给"看似重复的三层 Article"一个能复用的决策依据，什么时候分、什么时候合、分了换什么
